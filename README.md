...
| 游戏开始界面 | 属性面板 |
| :---: | :---: |
| ![游戏开始界面](image/README/游戏开始界面图.png) | ![属性面板](image/README/属性面板.png) |

| 技能面板 | 存档界面 |
| :---: | :---: |
| ![技能面板](image/README/技能面板.png) | ![存档界面](image/README/存档界面.png) |

- **游戏开始界面**：展示主菜单与游戏启动画面。
- **属性面板**：实时显示角色力量、智力、韧性、耐力等核心属性与元素抗性。
- **技能面板**：查看、升级与装备技能，被动技能（灵气护盾 / 生命汲取 / 法力汲取）在此展示技能描述。
- **存档界面**：游戏进度与存档管理。
